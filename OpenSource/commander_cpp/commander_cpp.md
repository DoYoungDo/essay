...
作者我本人经常会写一些命令行小工具，  
此前一直使用node.js的三方库[commander.js](https://github.com/tj/commander.js)来解析命令行参数,  
...
于是，我决定仿照commander.js的设计，写一个c++的命令行参数解析库，取名为`commander-cpp`，头文件名为`commander_cpp.hpp`


### 仓库

仓库地址：[https://github.com/DoYoungDo/commander-cpp](https://github.com/DoYoungDo/commander-cpp)
...
将 `commander_cpp.hpp` 文件复制到项目中，并在代码中包含它：
...
[更多示例...](https://github.com/DoYoungDo/commander-cpp)
